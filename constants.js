export const PROTOCOL3000COMMANDS = [
    ...
    },
    {
        id: "X-PRIORITY",
        label: "X-PRIORITY",
        parameters: "<direction_type>.<port_format>.<port_index>.<signal_type>, [<direction_type>.<port_format>.<port_index>.<signal_type> , ...]",
    },
    {
        id: "X-PRIORITY?",
        label: "X-PRIORITY?",
    ...
    },
    {
        id: "X-ROUTE",
        label: "X-ROUTE",
        parameters: "[<direction_type1>.<port_type1>.<port_index1>.<signal_type1>.<index1>, ...], <direction_type2>.<port_type2>.<port_index2>.<signal_type2>.<index2>",
    },
    {
        id: "X-ROUTE?",
        label: "X-ROUTE?",
